...
public interface MovieApiService {
    ...
    Call<MovieResponse> getMovie(@Query("api_key") String apiKey, @Query("language") String language, @Query("region") String region, @Query("sort_by") String sortBy,
                                 ...
                                 @Query("vote_average.gte") int ratingMin, @Query("vote_average.lte") int ratingMax, @Query("with_genres") String includedGenres, @Query("without_genres") String excludedGenres);
